Contributing to Krium Client
============================

The Krium Client project operates an open contributor model where anyone is
...
The following applies to code changes to the Krium Client project, and is not to be
confused with overall kum Network Protocol consensus changes.

Whether a pull request is merged into Krium Client rests with the project merge
...
Patches that change kum consensus rules are considerably more involved than
...
Where a patch set proposes to change the kum consensus, it must have been
...
The project leader is the release manager for each Krium Client release.
