...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* kum features */
        {"kum", "masternode", &masternode, true, true, false},
        {"kum", "masternodelist", &masternodelist, true, true, false},
        {"kum", "mnbudget", &mnbudget, true, true, false},
        {"kum", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"kum", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"kum", "mnsync", &mnsync, true, true, false},
        {"kum", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"kum", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use kumd, or the -server option to kum-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> kum-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:52553/\n";
}
