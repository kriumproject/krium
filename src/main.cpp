...
#if defined(NDEBUG)
#error "kum cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight <= 10) {
        ...
        nSubsidy = 150000 * COIN;                     // 15% of total supply (6 Million KUM) premined for development purpose
    } else if (nHeight > 50 && nHeight <= 5000 ) {
        nSubsidy = 0 * COIN;
    } else if (nHeight > 5000 && nHeight <= 7501 ) {  // Last POW Block
        nSubsidy = 5 * COIN;
    } else if (nHeight > 7501 && nHeight <= 533102 ) { // Start POS + Seesaw Rewards Mechanism activation for masternodes
        nSubsidy = 20 * COIN;
    } else if (nHeight > 533102 && nHeight <= 1058703 ) {
        nSubsidy = 14 * COIN;
    } else if (nHeight > 1058703 && nHeight <= 1584304 ) {
        nSubsidy = 9.8 * COIN;
    } else if (nHeight > 1584304 && nHeight <= 2109905 ) {
        nSubsidy = 6.86 * COIN;
    } else if (nHeight > 2109905 && nHeight <= 2635506 ) {
        nSubsidy = 4.8 * COIN;
    } else if (nHeight > 2635506 && nHeight <= 3161107 ) {
        nSubsidy = 3.36 * COIN;
    } else if (nHeight > 3161107 && nHeight <= 3686708 ) {
        nSubsidy = 2.35 * COIN;
    } else if (nHeight > 3686708 && nHeight <= 4799829 ) {
        nSubsidy = 1.65 * COIN;
    } else if (nHeight > 4799829) {
        nSubsidy = 0 * COIN;
    }
return nSubsidy;
}
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    if (nHeight <= 7501) {
        ...
        int64_t mNodeCoins = mnodeman.size() * 35000 * COIN; // Collateral needed to run a single Krium Masternode

        //if a mn count is inserted into the function we are looking for a specific result for a masternode count
        if(nMasternodeCount)
            mNodeCoins = nMasternodeCount * 35000 * COIN;
