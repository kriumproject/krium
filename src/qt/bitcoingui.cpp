                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Krium Client") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a kum address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kum: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Krium Client"), this);
    aboutAction->setStatusTip(tr("Show information about Krium Client"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for kum"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your kum addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified kum addresses"));
    ...
    openAction->setStatusTip(tr("Open a kum: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Krium Client help message to get a list with possible kum command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Krium Client client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to kum network", "", count));
}
...
{
    QString strTitle = tr("Krium Client"); // default title
