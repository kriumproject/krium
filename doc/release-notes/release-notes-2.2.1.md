Krium Client version 2.2.1 is now available from:

  <https://github.com/kum-project/kum/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/kum-project/kum/issues>

Compatibility
==============

Krium Client is extensively tested on multiple operating systems using
...
Krium Client should also work on most other Unix-like systems but is not
...
of Bitcoin that kum was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/kum-project-translations/).
