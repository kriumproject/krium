...
In order to support loading of multiple wallets in kum-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kum.cpp.
...
Changes to kum.cpp
----------------------
kum.cpp is the entry point into kum-qt, and as such, will require some minor modifications to provide hooks for
