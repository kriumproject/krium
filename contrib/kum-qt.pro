...
RESOURCES += src/qt/kum.qrc src/qt/kum_locale.qrc

TRANSLATIONS += src/qt/locale/kum_bg.ts \
                src/qt/locale/kum_de.ts \
                src/qt/locale/kum_en.ts \
                src/qt/locale/kum_es.ts \
                src/qt/locale/kum_fi.ts \
                src/qt/locale/kum_fr.ts \
                src/qt/locale/kum_it.ts \
                src/qt/locale/kum_ja.ts \
                src/qt/locale/kum_pl.ts \
                src/qt/locale/kum_pt.ts \
                src/qt/locale/kum_ru.ts \
                src/qt/locale/kum_sk.ts \
                src/qt/locale/kum_sv.ts \
                src/qt/locale/kum_vi.ts \
                src/qt/locale/kum_zh_CN.ts \
                src/qt/locale/kum_zh_TW.ts
